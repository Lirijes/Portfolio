...
<template>
    <div class="projectdetail">
        <div class="container">
            <h2 class="projectdetail-title">{{ project ? project.projectTitle.toLocaleLowerCase() : 'Loading...' }}</h2>
            <p class="projectdetail-description">{{ project ? project.description : 'Loading...' }}</p>
            <div class="image-array-container">
                <div class="image-array" v-for="(image, index) in projectImages" :key="index">
