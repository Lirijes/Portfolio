...
export async function fetchSkill(id: string): Promise<Skill> {
  ...
  const baseUrl = config.public.apiBaseUrl;
  try {
    const response = await fetch(`${baseUrl}api/Profile/Skill?id=${id}`, {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
          "API_KEY": config.public.apiKey,
...
export async function fetchUtilities(): Promise<Utility[]> {
  ...
  const baseUrl = config.public.apiBaseUrl;
  try {
    const response = await fetch(`${baseUrl}api/Profile/Utilities`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        "API_KEY": config.public.apiKey,
...
export async function fetchUtility(id: string): Promise<Utility> {
  ...
  const baseUrl = config.public.apiBaseUrl;
  try {
    const response = await fetch(`${baseUrl}api/Profile/Utility?id=${id}`, {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
          "API_KEY": config.public.apiKey,
